...
int Main(char *pcArgument) {
  ...
  DrawText(qwWindowID, 5, 150, RGB(255, 255, 255), RGB(0, 0, 0), pcStartMessage,
...
void DrawGameArea(QWORD qwWindowID, POINT *pstMouseXY) {
  ...
  DrawLine(qwWindowID, pstMouseXY->iX, pstMouseXY->iY - RADIUS, pstMouseXY->iX,
           pstMouseXY->iY + RADIUS, RGB(255, 0, 0));
