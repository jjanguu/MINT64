...
void srand(QWORD qwSeed) { gs_qwRandomValue = qwSeed; }
...
BOOL SetMouseEvent(QWORD qwWindowID, QWORD qwEventType, int iMouseX,
  ...
  case EVENT_MOUSE_MBUTTONUP:
    ...
    if (ConvertPointScreenToClient(qwWindowID, &stMouseXY,
